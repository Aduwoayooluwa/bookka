...
const Navigation = (props: Props) => {
  ...
  return (
      ...
      <Link  className='border p-2 hidden md:flex border-blue-600 hover:bg-blue-600 hover:text-white bg-transparent rounded text-blue-600' href="/auth">Get Started</Link>
          ...
          <AnimatePresence>
            <motion.aside
              ...
              <motion.ol 
                ...
                <Link  href="/auth">
                  <Button className='border absolute bottom-32 border-white hover:bg-blue-600 hover:text-blue-500  bg-white text-blue-600'>
                   Get Started
                  </Button>
               </Link>
          </motion.ol>
